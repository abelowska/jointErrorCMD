...
dc_cond_prior = {
    ...
    'participants_varsigma_ne_pre_acc':[{
        'mean': {'loc':0, "scale":0.2},
        'sd': ('normal', {'shape':0, "scale":.5}),
    }, True],
    'participants_varsigma_ern':[[{
        'mean': {'loc':0, "scale":0.2},
        'sd': ('normal', {'shape':0, "scale":.5}),
    }, {
        'mean': {'loc':0, "scale":0.2},
    ...
    'varsigma_cond': [stats.norm(loc=0, scale=1), False],
    'varsigma_ne': [stats.norm(loc=0, scale=0.2), False],
    'varsigma_ern': [[stats.norm(loc=0, scale=0.2), stats.norm(loc=0, scale=0.2)], False],
    'varsigma_crn': [[stats.norm(loc=0, scale=0.2), stats.norm(loc=0, scale=0.2)], False],
    'delta_cond': [stats.norm(loc=0, scale=2), False],
    'delta_ne': [stats.norm(loc=0, scale=.5), False],
    'delta_ern': [[stats.norm(loc=0, scale=0.5), stats.norm(loc=0, scale=0.5)], False],
    'delta_crn': [[stats.norm(loc=0, scale=0.5), stats.norm(loc=0, scale=0.5)], False],
    
    'varsigma_pre_acc': [stats.norm(loc=0, scale=0.2), False],
    'varsigma_ne_pre_acc': [stats.norm(loc=0, scale=0.2), False],
    'varsigma_ne_cond': [stats.norm(loc=0, scale=0.2), False],
    'varsigma_pre_acc_cond':[stats.norm(loc=0, scale=0.2), False],
    'varsigma_ne_pre_acc_cond':[stats.norm(loc=0, scale=0.2), False],
