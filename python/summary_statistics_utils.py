...
def get_summary_with_bayes_factor(fit, priors_dict, variables_to_track, log=False, percentiles=(2, 98)):
    fit_df = fit.draws_pd()
    bayes_factors = dict()
...
def format_number(x, limit=1000):
